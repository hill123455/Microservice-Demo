...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
				...
				// The filter needs this auth manager to authenticate the user. .addFilter(new
	...
	// from database. // In addition, we need to define the password encoder also.
	// So, auth manager can compare and verify passwords. @Override
